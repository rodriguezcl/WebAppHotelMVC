    ...
    for (var i = 0; i < res.length; i++) {
        ...
        if (objConfiguracion.editar == true || objConfiguracion.eliminar == true) {
            ...
            if (objConfiguracion.editar == true) {
               ...
               onclick='${(objFormulario != undefined && objFormulario.formulariogenerico != undefined && objFormulario.formulariogenerico==true) ? "EditarGenerico" : objConfiguracion.callbackEditar}(${fila[objConfiguracion.propiedadId]})' >
